 ...
 * to reset \p device using ::cudaDeviceReset() before Direct3D 11 
 * interoperability on \p device may be enabled.
 *
 * Successfully initializing CUDA interoperability with \p pD3D11Device 
 * will increase the internal reference count on \p pD3D11Device.  This 
