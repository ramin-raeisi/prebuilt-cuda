...
#else /* __CUDA_ARCH__ >= 130 */

#define CUDART_INF              __hiloint2double(0x7ff00000, 0x00000000)
#define CUDART_NAN              __hiloint2double(0xfff80000, 0x00000000)
#define CUDART_NEG_ZERO         __hiloint2double(0x80000000, 0x00000000)
#define CUDART_MIN_DENORM       __hiloint2double(0x00000000, 0x00000001)
