...
/*DEVICE_BUILTIN*/
extern __host__ __device__ _CRTIMP double __cdecl floor(double) __THROW;
...
/*DEVICE_BUILTIN*/
extern __host__ __device__ _CRTIMP double __cdecl ldexp(double, int) __THROW;
/*DEVICE_BUILTIN*/
...
/*DEVICE_BUILTIN*/
extern __host__ __device__ _CRTIMP double __cdecl frexp(double, int*) __THROW;
/*DEVICE_BUILTIN*/
...
/*DEVICE_BUILTIN*/
extern __host__ __device__ _CRTIMP double __cdecl ceil(double) __THROW;
...
#if _MSC_VER < 1600
/*DEVICE_BUILTIN*/
extern __host__ __device__ _CRTIMP double __cdecl hypot(double, double) __THROW;
#else
/*DEVICE_BUILTIN*/
...
/*DEVICE_BUILTIN*/
extern __host__ __device__ double                 cospi(double);
/*DEVICE_BUILTIN*/
extern __host__ __device__ float                  cospif(float);

/*DEVICE_BUILTIN*/
extern __host__ __device__ double         __cdecl pow(double, double) __THROW;

/*DEVICE_BUILTIN*/
extern __host__ __device__ _CRTIMP double __cdecl modf(double, double*) __THROW;
...
/*DEVICE_BUILTIN*/
extern _CRTIMP __host__ __device__ float __cdecl asinf(float) __THROW;

/*DEVICE_BUILTIN*/
extern _CRTIMP __host__ __device__ float __cdecl atanf(float) __THROW;

/*DEVICE_BUILTIN*/
extern _CRTIMP __host__ __device__ float __cdecl atan2f(float, float) __THROW;
...
/*DEVICE_BUILTIN*/
extern _CRTIMP __host__ __device__ float __cdecl modff(float, float*) __THROW;
...
/*DEVICE_BUILTIN*/
extern _CRTIMP __host__ __device__ float __cdecl fmodf(float, float) __THROW;
